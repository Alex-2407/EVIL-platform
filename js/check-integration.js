...
const files = [
  ...
  { name: 'malware-card-template.html', category: 'Database' },
  ...
  { name: 'hacked-timeline.html', category: 'Attacks' },
  
  // Educazione (Education)
  { name: 'phishing-quiz.html', category: 'Education', trigger: 'phishing_quiz_completed' },
  { name: 'ethical-hacking.html', category: 'Education', trigger: 'ethical_hacking_completed' },
  ...
  // Simulazioni
  { name: 'social-engineering.html', category: 'Education', trigger: 'social_engineering_completed' },
];
...
const noTrigger = files.filter(f => f.trigger && f.name !== 'security-check.html' && f.name !== 'phishing-quiz.html');
