...
function ensureAuthManagerLoaded() {
  ...
  if (typeof scheduleInitAuthHeader === 'function' || typeof initAuthHeader === 'function') {
  ...
  window.__evilAuthManagerLoading = new Promise((resolve) => {
    ...
    script.src = '/js/auth-manager.js?v=20260606';
...
async function initEvilNavigation() {
  ...
  } else if (typeof initAuthHeader === 'function') {
