// Funzione globale per attivare/disattivare la matrice
window.toggleMatrix = function() {
  ...
  // Se l'animazione è già attiva, non fare nulla (o potresti aggiungere toggle off)
...
function startMatrixRain() {
  ...
  function draw() {
    ...
    frame++;
    // Continua l'animazione indefinitamente senza reindirizzare
