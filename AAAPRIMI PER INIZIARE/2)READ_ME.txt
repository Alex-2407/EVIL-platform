...
1. Fai doppio click su "index.html" nella stessa cartella
   (il file si aprirà automaticamente nel tuo browser)

2. OPPURE, apri il tuo browser preferito (Chrome, Firefox, Edge, Safari)
   e digita nella barra degli indirizzi:
   
   http://localhost:5000/

3. Goditi il sito! 🎬 Vedrai un'animazione introduttiva affascinante!
